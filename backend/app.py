...
def create_id_card_image(user_data):
    ...
    draw.text((100, 450), f"Gender: {user_data.sex}", fill=text_color, font=font)    
    draw.text((100, 500), f"Division: {user_data.division}", fill=text_color, font=font)
    draw.text((100, 550), f"Timings: {user_data.activity}", fill=text_color, font=font)
